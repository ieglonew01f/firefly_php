<div class="sidebar">
      ...
      <div class="media">
        <div class="media-left">
          <a href="/profile/{{ $username }}">
            <img width="42" height="42" class="media-object" src="/uploads/thumb_{{ $profile_picture }}">
          </a>
        </div>
  ...
  <ul class="list-unstyled sidebar-ul-links">
    <li><a href="/home"><span class="icon-home"></span> &nbsp; Home <span class="label label-primary pull-right"></span></a></li>
    <li><a href="/photos/{{ $username }}"><span data-icon="&#xe032;"></span> &nbsp; Photos</a></li>
    <li><a href="/videos/{{ $username }}"><span data-icon="&#xe07f;"></span> &nbsp; Videos</a></li>
    <li><a href="/inbox/{{ $username }}"><span data-icon="&#xe03f;"></span> &nbsp; Inbox <span class="label label-primary pull-right sidebar-inbox-badge"></span></a></li>
    <li><a href="/notifications" ><span data-icon="&#xe027;"></span> &nbsp; Notifications <span class="label label-primary pull-right sidebar-notif-badge"></span></a></li>

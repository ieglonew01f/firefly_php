      ...
      <ul class="list-unstyled sidebar-chat-list">
        <li>
          <div class="media">
            ...
            <div class="media-body vam"> <span class="label label-success pull-right">&nbsp;</span>
              <h4 class="media-heading">Mike Jones</h4>
            </div>
          </div>
        </li>
        <li>
          <div class="media">
            <div class="media-left">
              <a href="#">
                <img width="32" height="32" class="media-object" src="public/assets/img/avatars/real_female1.jpg">
              </a>
            </div>
            <div class="media-body vam"> <span class="label label-warning pull-right">&nbsp;</span>
              <h4 class="media-heading">Jake Joe</h4>
            </div>
          </div>
        </li>
        <li>
          <div class="media">
            <div class="media-left">
              <a href="#">
                <img width="32" height="32" class="media-object" src="public/assets/img/avatars/man_1.jpg">
              </a>
            </div>
            <div class="media-body vam"> <span class="label label-success pull-right">&nbsp;</span>
              <h4 class="media-heading">Ross Smith</h4>
            </div>
          </div>
        </li>
      </ul>
